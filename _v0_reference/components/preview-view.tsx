...
export function PreviewView({ onBack }: PreviewViewProps) {
  ...
  const [trimSensitivity, setTrimSensitivity] = useState("medium")
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="flex-1 bg-card rounded-2xl border border-border/50 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 bg-black/50 flex items-center justify-center relative">
            ...
            {/* Simulated cursor effect when magnification is on */}
            {cursorMagnification && (
              <motion.div
                initial={{ scale: 1 }}
                animate={{ scale: 1.1 }}
                transition={{ duration: 0.5, repeat: Infinity, repeatType: "reverse" }}
                className="absolute bottom-1/3 right-1/3 w-6 h-6 rounded-full border-2 border-primary/50 bg-primary/10"
              />
            )}
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-secondary/30 rounded-xl p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <Switch
                  ...
                  onCheckedChange={setCursorMagnification}
                />
              </div>
              {cursorMagnification && (
                <motion.div
                ...
                >
                  ...
                  <Slider
                    ...
                    max={3}
                    step={0.5}
                    onValueChange={setMagnificationFactor}
                    className="w-full"
                  />
                </motion.div>
              )}
            ...
            <div className="bg-secondary/30 rounded-xl p-4">
              <div className="flex items-center justify-between">
                ...
                <Switch checked={cursorSmoothing} onCheckedChange={setCursorSmoothing} />
              </div>
            </div>
            ...
            <div className="bg-secondary/30 rounded-xl p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <Switch checked={autoTrimSilences} onCheckedChange={setAutoTrimSilences} />
              </div>
              {autoTrimSilences && (
                <motion.div
                  initial={{ opacity: 0, height: 0 }}
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Select value={trimSensitivity} onValueChange={setTrimSensitivity}>
            ...
            {exportPresets.map((preset) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    className="h-8 px-4 rounded-lg bg-primary/20 hover:bg-primary/30 text-primary border border-primary/30"
                  >
                    导出
                  </Button>
                </div>
